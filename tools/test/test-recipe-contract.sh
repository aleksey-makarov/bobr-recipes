...
run_case "host-bundle-missing-launcher" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"'}}'
run_case "host-bundle-legacy-overrides" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"',"_overrides":'"${rootfs_tree}"'}}'
run_case "host-bundle-extra-input" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"',"extra":'"${rootfs_tree}"'}}'
run_case "host-bundle-empty-public-tools" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-unknown-config" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}},"audit":{}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-unknown-tool-field" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo","visibility":"public"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-invalid-argument" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo","argument_prefix":[{"literal":"-L"}]}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-invalid-path-source" fail '{"name":"host-bundle","tag":"HostBundle","config":{"arch":"x86_64","library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}},"environment":{"XDG_DATA_DIRS":{"operation":"replace","paths":[{"source":"host","path":"usr/share"}]}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
