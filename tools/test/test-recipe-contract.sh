...
rootfs_tree='{"name":"rootfs-tree","tag":"Tree","config":{"tree":{"entries":[{"type":"dir","path":"bin"}]}},"inputs":{}}'
...
run_case "host-bundle" pass '{"name":"host-bundle","tag":"HostBundle","config":{"policy":"strict","min_kernel":"4.19","library_dirs":["usr/lib64","usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo","argv0":"demo","environment":{"TERMINFO_DIRS":{"operation":"replace","paths":[{"source":"payload","path":"usr/share/terminfo"}]}}}},"internal_tools":{"helper":{"path":"usr/libexec/helper"}},"environment":{"QEMU_AUDIO_DRV":{"operation":"default","values":["none"]},"XDG_DATA_DIRS":{"operation":"prepend","paths":[{"source":"payload","path":"usr/share"},{"source":"overrides","path":"share"}],"inherit":true,"host_default":["/usr/share"]}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"',"overrides":'"${rootfs_tree}"'}}'
run_case "host-bundle-minimal" pass '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":[],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-missing-launcher" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"'}}'
run_case "host-bundle-legacy-overrides" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"',"_overrides":'"${rootfs_tree}"'}}'
run_case "host-bundle-extra-input" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"',"extra":'"${rootfs_tree}"'}}'
run_case "host-bundle-empty-public-tools" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-unknown-config" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}},"audit":{}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-unknown-tool-field" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo","visibility":"public"}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
run_case "host-bundle-invalid-path-source" fail '{"name":"host-bundle","tag":"HostBundle","config":{"library_dirs":["usr/lib"],"public_tools":{"demo":{"path":"usr/bin/demo"}},"environment":{"XDG_DATA_DIRS":{"operation":"replace","paths":[{"source":"host","path":"usr/share"}]}}},"inputs":{"_root":'"${rootfs_tree}"',"_launcher":'"${rootfs_tree}"'}}'
...
run_case "cmake-package" pass '{"name":"pkg-package","tag":"Cmake","deps":{"build":[],"runtime":[]},"config":{"cmake_args":["-DBUILD_TESTS=OFF"],"make_args":["-j1"]},"inputs":{"source":'"${source_node}"',"patch":'"${patch_node}"'}}'
run_case "cmake-package-empty-config" pass '{"name":"pkg-package","tag":"Cmake","deps":{"build":[],"runtime":[]},"config":{},"inputs":{"source":'"${source_node}"'}}'
run_case "missing-cmake-package-deps" fail '{"name":"pkg-package","tag":"Cmake","config":{"cmake_args":["-DBUILD_TESTS=OFF"]},"inputs":{"source":'"${source_node}"'}}'
run_case "bad-cmake-package-config" fail '{"name":"pkg-package","tag":"Cmake","deps":{"build":[],"runtime":[]},"config":{"cmake_args":"-DBUILD_TESTS=OFF"},"inputs":{"source":'"${source_node}"'}}'
...
run_case "tree-bad-entry-type" fail '{"name":"runtime-tree","tag":"Tree","config":{"tree":{"entries":[{"type":"pipe","path":"lib"}]},"install":{"rules":[{"path":"**","attrs":{"uid":0,"gid":0,"directory_mode":493,"regular_file_mode":420,"executable_file_mode":493}}]}},"inputs":{}}'
run_case "tree-symlink-missing-target" fail '{"name":"runtime-tree","tag":"Tree","config":{"tree":{"entries":[{"type":"symlink","path":"lib"}]},"install":{"rules":[{"path":"**","attrs":{"uid":0,"gid":0,"directory_mode":493,"regular_file_mode":420,"executable_file_mode":493}}]}},"inputs":{}}'
