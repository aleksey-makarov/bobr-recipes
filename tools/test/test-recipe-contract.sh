...
run_case "tree-bad-entry-type" fail '{"name":"runtime-tree","tag":"Tree","config":{"tree":{"entries":[{"type":"symlink","path":"lib","target":"usr/lib"}]},"install":{"owners":[{"path":"**","uid":0,"gid":0}]}},"inputs":{}}'
