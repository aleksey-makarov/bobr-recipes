...
run_case "autotools" pass '{"name":"pkg","tag":"Autotools","config":{"configure_args":["--disable-nls"],"pre_configure":{"name":"patch","run_as":"build-user","argv":["patch","-p1","-i","${patch}"]},"post_install":[{"name":"link","run_as":"root","argv":["ln","-svf","tool","${out}/usr/bin/tool"]}]},"inputs":{"image":{"name":"img","tag":"ContainerImage","config":{"image":"docker.io/library/alpine:latest","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"inputs":{}},"source":{"name":"src","tag":"Fetch","config":{"url":"https://example.invalid/src.tar.xz","hash":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},"inputs":{}},"patch":{"name":"patch","tag":"Fetch","config":{"url":"https://example.invalid/src.patch","hash":"sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","unpack":false},"inputs":{}}}}'
run_case "makefile" pass '{"name":"pkg","tag":"Makefile","config":{"make_args":["PREFIX=/usr"],"pre_build":{"name":"patch","run_as":"build-user","argv":["patch","-p1","-i","${patch}"]},"post_install":[{"name":"link","run_as":"root","argv":["ln","-svf","tool","${out}/usr/bin/tool"]}],"skip_install":true},"inputs":{"image":{"name":"img","tag":"ContainerImage","config":{"image":"docker.io/library/alpine:latest","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"inputs":{}},"source":{"name":"src","tag":"Fetch","config":{"url":"https://example.invalid/src.tar.xz","hash":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},"inputs":{}},"patch":{"name":"patch","tag":"Fetch","config":{"url":"https://example.invalid/src.patch","hash":"sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","unpack":false},"inputs":{}}}}'
run_case "meson" pass '{"name":"pkg","tag":"Meson","config":{"setup_args":["--buildtype=release"],"build_dir":"build","pre_configure":{"name":"patch","run_as":"build-user","argv":["patch","-p1","-i","${patch}"]},"post_install":[{"name":"link","run_as":"root","argv":["ln","-svf","tool","${out}/usr/bin/tool"]}]},"inputs":{"image":{"name":"img","tag":"ContainerImage","config":{"image":"docker.io/library/alpine:latest","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"inputs":{}},"source":{"name":"src","tag":"Fetch","config":{"url":"https://example.invalid/src.tar.xz","hash":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},"inputs":{}},"patch":{"name":"patch","tag":"Fetch","config":{"url":"https://example.invalid/src.patch","hash":"sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","unpack":false},"inputs":{}}}}'
run_case "perl-module" pass '{"name":"pkg","tag":"PerlModule","config":{"perl_args":["INSTALLDIRS=vendor"],"make_args":["DESTDIR=/tmp/out"],"pre_configure":{"name":"patch","run_as":"build-user","argv":["patch","-p1","-i","${patch}"]},"post_install":[{"name":"link","run_as":"root","argv":["ln","-svf","tool","${out}/usr/bin/tool"]}]},"inputs":{"image":{"name":"img","tag":"ContainerImage","config":{"image":"docker.io/library/alpine:latest","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"inputs":{}},"source":{"name":"src","tag":"Fetch","config":{"url":"https://example.invalid/src.tar.xz","hash":"sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"},"inputs":{}},"patch":{"name":"patch","tag":"Fetch","config":{"url":"https://example.invalid/src.patch","hash":"sha256:cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","unpack":false},"inputs":{}}}}'
run_case "binary" pass '{"name":"bin","tag":"Binary","config":{"steps":[{"name":"install","run_as":"root","cwd":"${build}","argv":["${script}","install"]}]},"inputs":{"image":{"name":"img","tag":"ContainerImage","config":{"image":"docker.io/library/alpine:latest","digest":"sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"},"inputs":{}},"script":{"name":"script","tag":"Text","config":{"source":"#!/bin/sh\n","executable":true},"inputs":{}},"source":{"name":"src","tag":"Tree","config":{"tree":{"entries":[{"type":"dir","path":"src"}]}},"inputs":{}}}}'
